  ...
  internal = rec {
    ...
    crates = {
      ...
      "hashicorp_vault" = rec {
        ...
        edition = "2018";
        src = pkgs.fetchgit {
          url = "https://github.com/grahamc/vault-rs.git";
          rev = "148b22a4dc5d1e16999591f604db3305ea7415ef";
          sha256 = "07wbv0lvqpj3bg0z7wpjkf46vhq00v9gj72s2b72g0x47l1kbwbn";
        };
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "vault_0_6_1" "vault_0_6_2" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
